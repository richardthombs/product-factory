...
import { createRequirement } from "../commands/createRequirement.js";
...
async function main(): Promise<void> {
  ...
  console.log("Created proposed requirement change.");
...
function singleArg(args: Record<string, string[]>, key: string): string | undefined {
  ...
  if (values.length > 1 && key !== "acceptance-criterion-text") {
